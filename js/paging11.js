        ...
        nowPage: 1, allPages: Math.ceil(data.count / 20), displayPage: 21, callBack: function (now) {
            ...
            for (var i = 0; i < currentPages; i++) {
                ...
                var  _html = 
                  ...
                  '</br>44'+books[num].type+'</p>'+'<p style="float:left;font-size: 0.8rem;color:white;">'+'Features<br>'+
                   ...
                   '<p class="hc_tit s22" style="text-align: center;color:white;background-image: url(./templates/2019/images/pt_bg.png);">'+books[num].pitchs+
